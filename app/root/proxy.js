...
var getUrlProps = exports.getUrlProps = function(url) {
    ...
    if (o) {
        ...
        if (userInfo) {
            ...
            //username = request.env.servlet.getServletConfig().getInitParameter("app.maksUserName");
            //password = request.env.servlet.getServletConfig().getInitParameter("app.maksPassword");

            username= 'KRM-7143746';
            password= 'GAntep2013';
